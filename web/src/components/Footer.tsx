          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/profile.php?id=61590859552347" target="_blank" rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#024f7d] transition-colors" aria-label="Facebook">
              ...
              <a href="https://wa.me/50672071157" target="_blank" rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#024f7d] transition-colors" aria-label="WhatsApp">
