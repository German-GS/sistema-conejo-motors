        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/profile.php?id=61590859552347" target="_blank" rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#00a651] transition-colors" aria-label="Facebook">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://wa.me/50672071157" target="_blank" rel="noreferrer"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#00a651] transition-colors" aria-label="WhatsApp">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={href}>
                  <Link href={href} className="hover:text-[#00a651] transition-colors">{label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                <span className="text-lg">📞</span>
                <a href="tel:+50672071157" className="hover:text-[#00a651] transition-colors">7207-1157</a>
              </li>
              <li className="flex items-center gap-2">
                <span className="text-lg">📧</span>
                <a href="mailto:ventas@conejomotors.com" className="hover:text-[#00a651] transition-colors">ventas@conejomotors.com</a>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-lg">🕐</span>
